...
#outputFilename = 'Gait2D_v43'
#buildExternalFunction(outputFilename, pathExample, 30,
#                       compiler=compiler)

outputFilename = 'Gait2D_v43_Fext'
buildExternalFunction(outputFilename, pathExample, 36,
                       compiler=compiler)